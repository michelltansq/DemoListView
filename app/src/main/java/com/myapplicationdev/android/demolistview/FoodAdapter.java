...
public class FoodAdapter extends ArrayAdapter<Foody> {

    private ArrayList<Foody> food;
    private Context context;
    private TextView tvFoodName;
    private ImageView ivStar;

    public FoodAdapter(Context context, int resource, ArrayList<Foody> objects){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Foody currentFood = food.get(position);
